...
<body>
	...
	<div class="container">
		<div class="header_top">
			<span style="font-size:50px;color:#2c2f84;font-weight:bolder;margin-left:15px;">Smart Health Care</span>
		</div>
	...
	<div class="login">
		<!-- <h1 class="text-center" style="background-color:;color: #fff;">Admin Panel</h1> -->
			<div class="formstyle" style="padding: 10px;border: 1px solid lightgrey;margin-right: 476px;margin-left: 506px; margin-bottom: 25px;background-color:white;">
